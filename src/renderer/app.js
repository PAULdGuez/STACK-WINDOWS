let availableWindows = [];
    ...
    function renderAvailable() {
      ...
      const windowsToRender = sortAvailableAlpha
        ? [...availableWindows].sort((a, b) => (a.title || '').localeCompare(b.title || '', undefined, { sensitivity: 'base' }))
        : availableWindows;
    ...
    async function init() {
      if (!window.electronAPI) {
        ...
        document.getElementById('managedList').innerHTML = '<div class="empty-state">Error: API bridge failed to load.<br>Please restart the app.</div>';
        return;
      }
      ...
      document.getElementById('bgColorInput').addEventListener('change', function(e) {
